...
# Spender's address (who will spend the tokens)234ult23sss
spender_address = "0xd91E80cF2E7be2e162c6513ceD06f1dD0dA35296"
...
transaction = erc20_contract.functions.approve(
    ...
    'chainId': 137,  # Mainnet chain ID. Use 3 for Ropsten, 4 for Rinkeby, etc.sss
    'gas': 300000,  # Gas limit
    'gasPrice': web3.to_wei('1280', 'gwei'),  # Gas pricex
